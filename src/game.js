...
function preload() {
  ...
  this.load.image(
   ...
   this.load.image('enemy', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQav_4t7q1euOhOYXkMfCk-zXm7-Fc_THwMLA&s'
   );
...
function shootBullet() {
  ...
  if (bullet) {
    ...
    bullet.setVelocityX(facing === "right" ? 400 : -400);

    this.time.delayedCall(1500, () => {
      bullets.killAndHide(bullet);
      bullet.body.enable = false;
    });
    bullet.setPosition(player.x + (facing === "right" ? 20 : -20), player.y);
  }
}
